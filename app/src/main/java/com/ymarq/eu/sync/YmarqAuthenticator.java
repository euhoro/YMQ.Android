...
/**
 * Manages "Authentication" to Ymarq's backend service.  The SyncAdapter framework
 ...
 */
public class YmarqAuthenticator extends AbstractAccountAuthenticator {

    public YmarqAuthenticator(Context context) {
        super(context);
    }
